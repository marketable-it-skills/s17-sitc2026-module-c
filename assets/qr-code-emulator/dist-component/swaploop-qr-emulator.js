...
`;return typeof u=="function"&&u(null,I),I},gt}var Gt;function Re(){if(Gt)return x;Gt=1;const i=re(),r=Ee(),o=Ce(),e=Be();function t(n,s,u,a,c){const f=[].slice.call(arguments,1),E=f.length,g=typeof f[E-1]=="function";if(!g&&!i())throw new Error("Callback required as last argument");if(g){if(E<2)throw new Error("Too few arguments provided");E===2?(c=u,u=s,s=a=void 0):E===3&&(s.getContext&&typeof c>"u"?(c=a,a=void 0):(c=a,a=u,u=s,s=void 0))}else{if(E<1)throw new Error("Too few arguments provided");return E===1?(u=s,s=a=void 0):E===2&&!s.getContext&&(a=u,u=s,s=void 0),new Promise(function(l,S){try{const A=r.create(u,a);l(n(A,s,a))}catch(A){S(A)}})}try{const l=r.create(u,a);c(null,n(l,s,a))}catch(l){c(l)}}return x.create=r.create,x.toCanvas=t.bind(null,o.render),x.toDataURL=t.bind(null,o.renderToDataURL),x.toString=t.bind(null,function(n,s,u){return e.render(n,u)}),x}var ve=Re();const Me=ne(ve),Wt="swaploop-qr-emulator";class Zt extends HTMLElement{static observedAttributes=["service-url","scan-duration","scan-request-id","cancel-request-id","reset-request-id"];#n=null;#t=!1;#r="idle";#i="";constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.#s()}disconnectedCallback(){this.#o()}attributeChangedCallback(r,o,e){if(!(!this.isConnected||o===e)){if(r==="scan-request-id"&&o!==null){this.startScan();return}if(r==="cancel-request-id"&&o!==null){this.cancelScan();return}if(r==="reset-request-id"&&o!==null){this.reset();return}this.#s()}}get serviceUrl(){return(this.getAttribute("service-url")||"http://localhost:4020").replace(/\/$/,"")}set serviceUrl(r){this.setAttribute("service-url",r)}get scanDuration(){const r=Number(this.getAttribute("scan-duration")||2500);return Number.isFinite(r)&&r>=0?r:2500}async startScan(){this.#o(),this.#t=!0,this.#i="";const r=new AbortController;this.#n=r,this.#e("scanning","Reading the current QR code…"),await this.#a(r)}cancelScan(){this.#o(),this.#e("idle","Scan cancelled.")}reset(){this.#o(),this.#i="",this.#e("idle","Ready to scan a simulated QR code.")}async#a(r){if(this.#t)try{let o,e;if(await Promise.all([fetch(`${this.serviceUrl}/api/qr/current`,{headers:{Accept:"application/json"},signal:r.signal}).then(n=>{o=n}).catch(n=>{e=n}),this.#u(r.signal)]),e)throw e;if(o.status===404){this.#t=!1,this.#e("error","No QR code is currently selected.");return}if(!o.ok)throw new Error(`Station Service returned HTTP ${o.status}`);const t=await o.json();if(typeof t.payload!="string"||t.payload.length===0)throw new Error("The Station Service returned an invalid QR payload");this.#i=await Me.toDataURL(t.payload,{width:260,margin:2,color:{dark:"#102a2a",light:"#ffffff"},errorCorrectionLevel:"M"}),this.#t=!1,this.#e("success","QR code scanned successfully."),this.dispatchEvent(new CustomEvent("qr-scan",{detail:{payload:t.payload},bubbles:!0,composed:!0}))}catch(o){if(o instanceof DOMException&&o.name==="AbortError")return;this.#t=!1,this.#e("error",o instanceof Error?o.message:"Unable to reach the Station Service")}finally{this.#n===r&&(this.#n=null)}}#u(r){return new Promise(o=>{const e=()=>{window.clearTimeout(t),r.removeEventListener("abort",e),o()},t=window.setTimeout(e,this.scanDuration);r.addEventListener("abort",e,{once:!0})})}#e(r,o){this.#r=r,this.#s(),this.dispatchEvent(new CustomEvent("qr-scan-state",{detail:{state:r,message:o},bubbles:!0,composed:!0}))}#o(){this.#n?.abort(),this.#n=null,this.#t=!1}#s(){const r=this.#r==="scanning",o={idle:"Ready",scanning:"Scanning",success:"Scanned",error:"Error"}[this.#r];this.shadowRoot.innerHTML=`
      <style>
        ...
        * { box-sizing: border-box; }
        ...
        .dot {
          ...
          height: 7px;
          border-radius: 50%;
          background: ${this.#r==="error"?"#d97706":this.#r==="success"?"#0d9488":"#6b817e"};
      ...
      <section class="scanner" aria-label="SwapLoop QR scanner emulator">
        <header class="header">
          ...
          <span class="status"><span class="dot"></span>${o}</span>
        </header>
        ...
        <div class="body">
          <div class="viewport">
            ...
            <div class="frame">
              ...
              ${this.#i?`<img class="qr" src="${this.#i}" alt="Simulated QR code" />`:`<div class="placeholder">
